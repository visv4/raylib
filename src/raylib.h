...
RLAPI Model LoadModelFromMemory(const char *fileName, const char* glTFData, const int size);                                          // Load model from memory (Only glTF)
...
RLAPI void UpdateEmpties(Model *model, ModelAnimation anim, int frame);                     // Update model empties based on animation.
